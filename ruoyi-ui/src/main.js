...
// vform 富文本组件
import RichTextWidget from '@/components/vform/RichTextWidget.vue'
import GlobalApiPlugin from '@/utils/global-api';
...
Vue.component('rich-text-widget', RichTextWidget)

//同时注册了v-form-designer、v-form-render等组件
Vue.use(vform)

// 手动注册缺失的组件
if (vform.SubFormWidget) {
  Vue.component('sub-form-widget', vform.SubFormWidget)
}
