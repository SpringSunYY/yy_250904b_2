<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="inspectionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="使用部门" :show-overflow-tooltip="true" align="center" v-if="columns[4].visible"
                       prop="userUnit"
      />
      <el-table-column label="管理人员" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible"
                       prop="manager"
      />
      <el-table-column label="联系电话" :show-overflow-tooltip="true" align="center" v-if="columns[6].visible"
                       prop="contactPhone"
      />
      ...
      <el-table-column label="下次检验日期" align="center" v-if="columns[9].visible" prop="nextInspectionDate"
                       width="180"
      >
        <template slot-scope="scope">
      ...
      <el-table-column label="检验机构" :show-overflow-tooltip="true" align="center" v-if="columns[11].visible"
                       prop="inspectionAgency"
      />
      <el-table-column label="报告编号" :show-overflow-tooltip="true" align="center" v-if="columns[12].visible"
                       prop="reportNo"
      />
